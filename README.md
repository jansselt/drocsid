...
The backend loads configuration from `config/default.toml` with environment variable overrides using the `DROCSID__` prefix (double underscore as separator).
